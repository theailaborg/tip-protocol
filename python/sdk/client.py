...
class TIPIdentityClient:
    ...
    def register(
        ...
        vp_signature: VP's ML-DSA-65 signature over (dedup_hash + verification_tier + vp_id)
        dedup_hash:   Poseidon(govId, dob, country) — generated by generateDedupProof() in shared/zk.js
        zk_proof:     Groth16 proof object { pi_a, pi_b, pi_c, protocol, curve }
