...
// ISO 3166-1 alpha-2 (249 officially assigned) plus XK, the user-assigned code
// in common use for Kosovo. Identity region is held to this set at registration.
...
// uncommitted tx older than this stops being a chain base. Must exceed a deep
// lane's worst-case commit latency , expiry mid-flight makes the next seal a
// SIBLING and cascades (2026-07-12); a lost tx still unblocks via ghost rebuild.
...
const PROTOCOL = Object.freeze({
  ...
  short: "TIP",
  // Bound into the hashed genesis payload: changing it changes genesis_hash and
  // every node fail-stops at boot. The node's own build version is separate
  // (config.nodeVersion / TIP_BUILD_VERSION).
  version: "2.0.0",
