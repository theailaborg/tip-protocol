 ...
 *     tx.timestamp)`.
 *   - The user supplies a fresh zk_proof bound to the SAME dedup_hash
 *     as the original REGISTER_IDENTITY for this tip_id. The API node
 *     verifies it against the stored dedup_hash before submitting the
 ...
 *                                     (same circuit as REGISTER_IDENTITY,
 *                                     regenerated by the user at recovery
 *                                     time from their gov-id witness)
 *
