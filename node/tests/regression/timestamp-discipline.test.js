...
// Parse the createTable blocks in the migration baseline file and return a
// Map<tableName, Set<columnName>> of every bigInteger column. (PR #118 moved
// schema from knex-adapter.js _ensureSchema() to 000_baseline.js; PR #204
// wrapped every create in the idempotent `_createTable(knex, "<table>", t =>`
// helper — so both call shapes are matched here:
//   await knex.schema.createTable("<table>", t => { ... })
//   await _createTable(knex, "<table>", t => { ... })
