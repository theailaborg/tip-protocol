...
const CASES = [
  ...
  ["JURY_VOTE_REVEAL", "with_optional", { juror_tip_id: "tip://id/US-juror", vote: "MISMATCH", salt: "salt-1", ctid: "ctid-deadbeef", is_appeal: false, confirmed_origin: "AG" }],
  ["CONTENT_DISPUTED", "required_only", { disputer_tip_id: "tip://id/US-disp", reason: "mislabel", ctid: "ctid-deadbeef" }],
  ["CONTENT_DISPUTED", "with_optional", { disputer_tip_id: "tip://id/US-disp", reason: "mislabel", ctid: "ctid-deadbeef", claimed_origin: "MX", evidence_hash: "ev-hash" }],
